...
- (void)viewDidLoad {
    ...
    NSLog(@"%@-%@-%@-%@-%f-%@-%@-%@",sysName,sysVer,model,name,batterylevel,weizhi,orientation,uuid);
    ...
    [nextViewClick12 addTarget:self action:@selector(next) forControlEvents:UIControlEventTouchUpInside];
