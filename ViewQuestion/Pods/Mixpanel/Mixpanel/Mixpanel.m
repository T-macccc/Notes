...
- (void)connectToABTestDesigner:(BOOL)reconnect
{
    if ([self.abtestDesignerConnection isKindOfClass:[MPABTestDesignerConnection class]] && ((MPABTestDesignerConnection *)self.abtestDesignerConnection).connected) {
        ...
        void (^connectCallback)(void) = ^{
            ...
            NSLog(@"oldInterval before:%d",oldInterval);
            strongSelf.flushInterval = 11;
            NSLog(@"oldInterval after:%d",oldInterval);
        ...
        id stop = self.abtestDesignerConnection;
        NSLog(@"-->self.abtestDesignerConnection:%@",self.abtestDesignerConnection);
    }
}
